"""refactor_vendor_to_user_model

Revision ID: 988348837466
Revises: 
Create Date: 2026-07-26 01:20:20.733404
...
def downgrade() -> None:
    ...
    sa.Column('role', postgresql.ENUM('VENDOR', 'ADMIN', 'MARKETPLACE', name='userrole'), autoincrement=False, nullable=False),
