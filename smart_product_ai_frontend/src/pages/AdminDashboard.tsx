...
export default function AdminDashboard() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Ensure the orders response is treated as an array.
  ...
  const handleAdminFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (adminModalMode === "create") {
        ...
        await api.post(
          `/admin/admins/${selectedAdminId}/reset-password`,
          {
      ...
      setAdminModalError(
        err.response?.data?.detail ||
          "An error occurred handling admin registry details."
      );
    }
  };
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-center items-center">
        ...
        <p className="text-slate-400 font-medium">
          Syncing Superadmin Control Portal...
        </p>
      </div>
    );
  }
        ...
        <header className="bg-white/[0.02] backdrop-blur-xl border border-white/5 p-8 rounded-3xl shadow-2xl flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="text-slate-400 mt-1 text-sm">
              Global Platform Metrics, AI Pipeline Monitoring, Moderation, &
              Developer API Ecosystem Management
            </p>
          </div>
          ...
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="bg-slate-900/60 p-6 rounded-3xl border border-white/5 shadow-xl">
                ...
                <h3 className="text-3xl font-black text-slate-100 mt-2">
                  {stats?.total_published_products}
                </h3>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 space-y-4">
                <h3 className="text-lg font-bold tracking-tight">
                  Gemini 2.5 Flash Pipeline Status
                </h3>
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  ...
                  <div className="bg-slate-950 p-4 rounded-xl border border-white/5 col-span-2 flex justify-between items-center">
                    ...
                    <div>
                      ...
                      <span className="text-slate-200 font-bold text-lg mt-0.5 block">
                        {aiMetrics?.avg_processing_time_seconds}s
                      </span>
                    </div>
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-slate-200 font-bold text-lg mt-0.5 block">
                        {aiMetrics?.total_detected_items} units
                      </span>
                    </div>
              ...
              <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 space-y-4">
                ...
                <p className="text-xs text-slate-400">
                  Analyze inventory pricing trends and produce quality grades
                  to calculate optimal market limits.
                </p>

                <form
                  onSubmit={handlePriceSuggestion}
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <option value="Grade A Premium">
                        Grade A Premium (High Quality)
                      </option>

                      <option value="Grade B Choice">
                        Grade B Choice (Moderate Quality)
                      </option>

                      <option value="Standard">
                        Standard / Basic Produce
                      </option>
                    </select>
                  </div>
                  ...
                  >
                    {suggestLoading
                      ? "Calculating Price Bounds..."
                      : "Query Optimal suggested Price"}
                  </button>
                </form>
                ...
                {suggestedPrice && (
                  <div className="bg-emerald-500/10 border border-emerald-500/25 p-4 rounded-xl space-y-2 mt-4 text-xs">
                    ...
                    <span className="text-emerald-400 font-bold uppercase block tracking-wider text-[10px]">
                      Suggested Pricing Boundaries
                    </span>
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center pt-1 font-mono">
                      ...
                      <div className="border-x border-white/5">
                        <span className="text-[9px] text-emerald-400 block mb-0.5">
                          TARGET PRICE
                        </span>
                    ...
                    >
                      ...
                      <td className="py-4 px-4 text-right space-x-1.5 whitespace-nowrap">
                        ...
                        {!p.approved ? (
                          <button
                            onClick={() =>
                              handleModerateProduct(p.id, true)
                            }
                          ...
                          <button
                            onClick={() =>
                              handleModerateProduct(p.id, false)
                            }
        ...
        {activeTab === "developers" && (
          <div className="grid md:grid-cols-3 gap-8 items-start animate-in fade-in duration-200">
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 space-y-4">
              ...
              <p className="text-xs text-slate-400">
                Register a secure developer access token with assigned
                            ...
                            {eligibleUsers.map((user) => (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2 text-[10px] text-slate-500">
                                  ...
                                  <span className="bg-white/5 text-slate-400 px-1 rounded text-[8px] uppercase">
                                    {user.role}
                                  </span>
              ...
              {newlyCreatedKey && (
                <div className="bg-amber-500/10 border border-amber-500/25 p-4 rounded-xl space-y-2 mt-4 text-xs animate-in zoom-in duration-150">
                  ...
                  <span className="text-amber-400 font-bold uppercase block tracking-wider text-[10px]">
                    ⚠️ API Access Token Generated
                  </span>

                  <p className="text-slate-400 text-[11px]">
                    Copy this key hash now. It will not be shown again:
                  </p>
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 space-y-4 md:col-span-2 overflow-hidden">
              ...
              <h3 className="text-lg font-bold tracking-tight">
                Active API Subscription Tokens
              </h3>
                    ...
                    {devKeys.map((key) => (
                      ...
                      >
                        ...
                        <td className="py-4 px-4 text-slate-300 font-semibold">
                          {key.developer_email || "Deleted User"}
                        </td>
                        ...
                        <td className="py-4 px-4 font-mono font-medium">
                          {key.calls_made} calls
                        </td>

                        <td className="py-4 px-4 font-mono text-slate-500">
                          /{key.rate_limit_max} daily
                        </td>
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-6 space-y-4 animate-in fade-in duration-200">
            ...
            <div className="flex justify-between items-center border-b border-white/5 pb-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Complete administrative account lists, credential resets,
                ...
                <tbody className="divide-y divide-white/5">
                  ...
                  {adminsList.map((admin) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4 uppercase font-mono tracking-wider">
                        {admin.language || "en"}
                      </td>
                      ...
                      <td className="py-4 px-4 text-right space-x-1.5 whitespace-nowrap">
                        ...
                        <button
                          onClick={() =>
                            handleOpenResetPassword(admin.id)
                          }
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={adminCountry}
                      onChange={(e) =>
                        setAdminCountry(e.target.value)
                      }
                      className="w-full bg-slate-950 border border-white/10 rounded-xl px-3 py-2 text-white"
                    />
